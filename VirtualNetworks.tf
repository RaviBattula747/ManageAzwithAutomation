...
resource "azurerm_virtual_network_peering" "peering" {
	...
	for_each = {
		...
		"peer-shared-spoke-01-ea"	=	[0,1,0,0,false]
		"peer-spoke-01-shared-ea"	=	[0,0,1,0,true]

		"peer-shared-spoke-02-ea"	=	[0,2,0,0,false]
		"peer-spoke-02-shared-ea"	=	[0,0,2,0,true]
		
		"Global-peer-shared-ea-sa"	=	[1,4,0,0,true]
		"Global-peer-shared-sa-ea"	=	[0,0,4,1,true]

		"peer-shared-spoke-01-sa"	=	[1,3,4,1,false]
		"peer-spoke-shared-01-sa"	=	[1,4,3,1,true]
	}
